...
export const ALL_ITEMS: BookScreenItem[] = [
  {
    ...
    bookSummary:
      'Перша екранізація культової книги, що показує вступ Гаррі до Гоґвортсу. Його знайомство з друзями і світом магії.',
    filmSummary:
      "Перша екранізація культової книги, що показує вступ Гаррі до Гоґвортсу. Його знайомство з друзями і світом магії. Прем'єра відбулась у 2001 році і стала однією темою.",
    differences: [
      {
        id: 'hp-1-d1',
        title: 'Перше знайомство з Драко Малфоєм',
        bookText:
          "Гаррі знайомиться з Драко ще до школи — у магазині мантій Madam Malkin's. Це знайомство показує характер Малфоя ще до потрапляння в Гоґвортс.",
        filmText:
          'У фільмі ця сцена відсутня. Перше знайомство відбувається вже у замку, коли Гаррі та Рон приходять до великої зали.',
        isSpoiler: false,
      },
      {
        id: 'hp-1-d2',
      ...
      },
      {
        ...
        bookText:
          'Гаррі, Рон і Герміона довго возилися із Норбертом — драконом Гаґріда. Цей сюжет займає кілька розділів.',
